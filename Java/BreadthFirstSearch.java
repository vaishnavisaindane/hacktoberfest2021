...
public class BreadthFirstSearch {
    ...
    LinkedList<Integer> finalQueue = new LinkedList<>();
    ...
    void BFS(int s) {
        ...
        //printing the final queue which contains the final path
        ...
        //total cost of BFS search, because we are already in 2 cell need to minus 1
